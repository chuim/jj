...
fn test_commit_is_empty(indexed: bool) {
    ...
    assert_eq!(commit1.parent_tree(repo.as_ref()).unwrap(), root_tree);
    assert_eq!(commit2.parent_tree(repo.as_ref()).unwrap(), root_tree);
    assert_eq!(commit3.parent_tree(repo.as_ref()).unwrap(), root_tree);
    assert_eq!(commit4.parent_tree(repo.as_ref()).unwrap(), tree4);
}
